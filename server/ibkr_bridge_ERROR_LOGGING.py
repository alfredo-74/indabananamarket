#!/usr/bin/env python3
"""
🔥 IBKR BRIDGE - ERROR LOGGING VERSION ✅
==========================================
✅ UPDATED VERSION with HTTP error logging
✅ Shows exact error messages when requests fail
✅ Download THIS file instead of ibkr_bridge_v2.py
...
class IBKRBridgeV2:
    def __init__(self, replit_url: str):
        ...
        print(f"🚀 Bridge V2 initialized - Will forward data to: {self.replit_url}", file=sys.stderr)
